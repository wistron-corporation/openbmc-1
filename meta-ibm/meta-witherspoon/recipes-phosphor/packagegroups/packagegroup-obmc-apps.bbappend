...
RDEPENDS_${PN}-inventory_append_mowgli-server = " openpower-fru-vpd openpower-occ-control virtual/obmc-gpio-presence id-button"
...
RDEPENDS_${PN}-extras_append_mowgli-server = " phosphor-webui phosphor-image-signing phosphor-misc usb-network"
