...
RDEPENDS_${PN}-inventory_append_mowgli = " openpower-occ-control virtual/obmc-gpio-presence"
...
RDEPENDS_${PN}-extras_append_mowgli = " phosphor-webui phosphor-image-signing"
