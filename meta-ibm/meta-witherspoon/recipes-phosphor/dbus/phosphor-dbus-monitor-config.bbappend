...
PHOSPHOR_DBUS_MONITOR_CONFIGS_append_mowgli-server = " fan-policy"
PHOSPHOR_DBUS_MONITOR_CONFIGS_append_mowgli-server = " thermal-policy"
PHOSPHOR_DBUS_MONITOR_CONFIGS_append_mowgli-server = " power-supply-policy"
PHOSPHOR_DBUS_MONITOR_CONFIGS_append_mowgli-server = " events-policy"
