...
SYSTEMD_LINK_${PN}-presence_append_mowgli-server = " ${@compose_list(d, 'FMT_POWERSUPPLY', 'OBMC_POWER_SUPPLY_INSTANCES')}"
...
SYSTEMD_ENVIRONMENT_FILE_${PN}-presence_append_mowgli-server = " ${@compose_list(d, 'POWERSUPPLY_ENV_FMT', 'OBMC_POWER_SUPPLY_INSTANCES')}"
